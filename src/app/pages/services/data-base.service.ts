...
export class DataBaseService {
  ...
  async crearUsuariosDePrueba() {
    ...
    await this.guardarUsuario(Usuario.getNewUsuario(
      ...
      'admin@duocuc.cl', 
      'admin', 
      '¿Cuál es tu clave maestra?', 
      'admin', 
      'Administrador', 
      '', 
      NivelEducacional.findNivelEducacionalById(1)!, // Nivel básico
      new Date(2000, 0, 1),
      'Administración',
      '/../../src/assets/images/admin.png' // Imagen opcional
    ));
    ...
    await this.guardarUsuario(Usuario.getNewUsuario(
      ...
      new Date(2000, 0, 5),
      'La Florida',
      '/../../src/assets/images/fotoPerfilAna.png'
    ));
  ...
  async buscarUsuarioPorCuenta(cuenta: string): Promise<Usuario | undefined> {
    ...
    // Buscar usuario por correo    --por probar--
